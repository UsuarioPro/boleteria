        <!-- Outer-Footer /- -->
        <!-- Footer -->
        <footer class="footer" style="background: linear-gradient(to bottom, #ec2625, #cf0427, #8b0000);">
            <div class="container">
                <!-- Mid-Footer -->
                <div class="mid-footer-wrapper u-s-p-t-15">
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                            <div class="footer-list">
                                <h6 class="text-white">CENTRO DE AYUDA</h6>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                            <div class="footer-list">
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-12 text-center">
                            <div class="footer-list">
                                <h6 class="text-white">CONTACTANOS</h6>
                            </div>
                        </div>
                    </div>
                </div>
