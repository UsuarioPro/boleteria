        ...
        <div class="page-404">
                <div class="vertical-center">
                    <div class="text-center">
                        <h1 style="font-size: 120px; line-height: 100px;">¡Bienvenido a la <br> familia!</h1>
                        <h5>Tu cuenta ha sido creada con éxito. Ahora puedes explorar nuestros conciertos, promociones y mucho más.</h5>
                        <div class="redirect-link-wrapper u-s-p-t-25">
                            <a class="redirect-link" href="<?= _SERVER_ ?>">
