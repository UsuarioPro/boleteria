...
(function (root, factory) {
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function(side) {
            ...
            var arrow = this.locale.direction == 'ltr' ? {left: 'fa-angle-left', right: 'fa-angle-right'} : {left: 'fa-angle-right', right: 'fa-angle-left'};
        ...
        updateFormInputs: function() {
            ...
            this.container.find('input[name=daterangepicker_start]').val(this.startDate.format('DD/MM/YYYY'));
            if (this.endDate)
                // this.container.find('input[name=daterangepicker_end]').val(this.endDate.format(this.locale.format));
                this.container.find('input[name=daterangepicker_end]').val(this.endDate.format('DD/MM/YYYY'));
        ...
        move: function() {
            ...
            if (this.drops == 'up')
                containerTop = this.element.offset().top - this.container.outerHeight() - parentOffset.top - 17;
            else
                containerTop = this.element.offset().top + this.element.outerHeight() - parentOffset.top - 17;
        ...
        hoverRange: function(e) {
            ...
            if (label == this.locale.customRangeLabel) {
                ...
                this.container.find('input[name=daterangepicker_start]').val(dates[0].format('DD/MM/YYYY'));
                this.container.find('input[name=daterangepicker_end]').val(dates[1].format('DD/MM/YYYY'));
            }
        ...
        hoverDate: function(e) {
            ...
            if (this.endDate && !this.container.find('input[name=daterangepicker_start]').is(":focus")) {
                this.container.find('input[name=daterangepicker_start]').val(date.format('DD/MM/YYYY'));
                // this.container.find('input[name=daterangepicker_start]').val(date.format(this.locale.format));
            } else if (!this.endDate && !this.container.find('input[name=daterangepicker_end]').is(":focus")) {
                this.container.find('input[name=daterangepicker_end]').val(date.format('DD/MM/YYYY'));
