                        ...
                        <div class="card-body" id="listado_registros">
                            <table id="tbllistado" class="table table-head-fixed table-striped table-bordered table-condensed table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="all" title="">Imagen</th>
                                    <th class="all" title="Condicion de la Categoria">Tipo</th>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="formulario" name="formulario" method="POST" accept-charset="utf-8">
                                        <div class="modal-body">
                                            ...
                                            <input type="hidden" id="ban_tipo" name="ban_tipo">
...
<!-- FIN DE CONTENIDO -->
<script src="<?= _SERVER_ ?>app/views/banner/banner.js" type="text/javascript" charset="utf-8" async defer></script>
