            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <h1 class="m-0 text-dark"><?= $nombre_opcion?>                    
                        <button type="button" class="btn btn-outline-primary btn-flat btn-sm" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> Solitar un Evento</button>
                    </h1>
                </div><!-- /.col -->
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header pb-2">
                                        <h5 class="modal-title" id="titulo">Solicitar Evento</h5>
                                    ...
                                    <form id="formulario" name="formulario" method="POST" accept-charset="utf-8">
                                        <div class="modal-body pb-0 mb-0">
                                            <div class="row">
                                                <input type="hidden" value="<?= $_SESSION['cli_id']?>" id="cli_defaulf" hidden>
                                                <input type="hidden" value="0" id="con_estado" name="con_estado">
                                                <div class="form-group col-sm-12" id="div_organizador">
...
<!-- FIN DE CONTENIDO -->
<script src="<?= _SERVER_ ?>app/views/eventos/mis_eventos.js" type="text/javascript" charset="utf-8" async defer></script>