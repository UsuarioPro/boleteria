            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                    <h1 class="m-0 text-dark"><?= $nombre_opcion?>                    
                        <button style="visibility: hidden;" type="button" class="btn btn-outline-primary btn-flat btn-sm" title="Registrar Nueva Categoria" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus-circle"></i> <ins>A</ins>gregar</button>
                    </h1>
                </div><!-- /.col -->
...
<!-- FIN DE CONTENIDO -->
<script src="<?= _SERVER_ ?>app/views/eventos/solicitud.js" type="text/javascript" charset="utf-8" async defer></script>
