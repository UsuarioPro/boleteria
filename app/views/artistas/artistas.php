                        ...
                        <div class="card-body" id="listado_registros">
                            <table id="tbllistado" class="table table-head-fixed table-striped table-bordered table-condensed table-hover">
                                ...
                                <tr>
                                    ...
                                    <th class="all" title="Nombre de la Categoria">Grupo - Artista</th>
                                    <th class="all">Descripcion</th>
                                    <th class="all">Genero</th>
                                    <th class="all" title="">Logo</th>
                                    <th class="all" title="">Portada</th>
                                    ...
                                    <form id="formulario" name="formulario" method="POST" accept-charset="utf-8">
                                        <div class="modal-body pb-0 mb-0">
                                            <div class="form-group">
                                                <label>Nombre del Artista - Grupo</label><label class="text-red">(*)</label>
                                                <input type="hidden" name="art_id" id="art_id">
                                                <input type="text" class="form-control rounded-0 validacion_mayuscula" name="art_nombre" id="art_nombre" maxlength="100" placeholder="Nombre de la Categoria"required>
                                            </div>
                                            <div class="form-group">
                                                <label>Descripcion</label><label class="text-red">(*)</label>
                                                <textarea name="art_descripcion" id="art_descripcion" class="form-control rounded-0 validacion_mayuscula" placeholder="Descripcion" rows="4" required></textarea>
                                            </div> 
                                            <div class="form-group">
                                                <label>Ciudad</label>
                                                <input type="text" class="form-control rounded-0 validacion_mayuscula" name="art_genero" id="art_genero" maxlength="100" placeholder="Direccion" required>
                                            </div> 
                                            <div class="form-group">
                                            ...
                                            <div class="form-group mb-0">
                                                <label class="tooltip_tippy " data-tippy-content="<small>Tener en cuenta que la imagen tiene que se cuadrada 500 x 500 px minimo(*)</small>" >Portada <i class="fas fa-circle-info text-orange"></i> </label> <span class="text-red text-bold">(*)</span>
                                                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 p-0 m-0">
...
<!-- FIN DE CONTENIDO -->
<script src="<?= _SERVER_ ?>app/views/artistas/artistas.js" type="text/javascript" charset="utf-8" async defer></script>
