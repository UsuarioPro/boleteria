                        ...
                        <div class="card-body" id="listado_registros">
                            <table id="tbllistado" class="table table-head-fixed table-striped table-bordered table-condensed table-hover">
                                ...
                                <tr>
                                    ...
                                    <th title="Descripcion de la Categoria">Descripcion</th>
                                    ...
                                    <form id="formulario" name="formulario" method="POST" accept-charset="utf-8">
                                        <div class="modal-body">
                                            <div class="form-group">
                                                <label>Nombre de la Categoria</label><label class="text-red">(*)</label>
                                                <input type="hidden" name="cat_id" id="cat_id">
                                                <input type="text" class="form-control rounded-0 validacion_mayuscula" name="cat_nombre" id="cat_nombre" maxlength="100" placeholder="Nombre de la Categoria"required>
                                            </div>
                                            <div class="form-group">
                                                <label>Descripcion</label>
                                                <textarea name="cat_descripcion" id="cat_descripcion" class="form-control rounded-0 validacion_mayuscula"
                                                placeholder="Descripcion" cols="30" rows="2"></textarea>                                                
                                            </div> 
...
<!-- FIN DE CONTENIDO -->
<script src="<?= _SERVER_ ?>app/views/categoria/categoria.js" type="text/javascript" charset="utf-8" async defer></script>
